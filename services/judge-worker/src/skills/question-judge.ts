...
export function buildQuestionJudgePrompt(input: QuestionJudgeInput): string {
  return [
    ...
    'A false factual question about the story subject is NO, not IRRELEVANT, even when it covers no key point.',
    'Baseline examples: "这个人死了吗？" is NO; "故事里还有第二个人吗？" is NO; "是不是有蚊子？" is YES with no key point unless the complete hidden relationship is stated.',
